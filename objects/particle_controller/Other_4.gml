...
part_type_life(global.exhaust0, 6, 18);
...
part_type_scale(global.exhaust1, .3, .3);
...
part_type_step(global.exhaust0, ceil(1), global.exhaust1);
...
part_type_life(global.exhaust2, 2, 6);
...
part_type_scale(global.exhaust3, .15, .15);
